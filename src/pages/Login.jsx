...
import logoSENAuthenticator from "./media/assets/Logo Reconocimiento Facial - Blanco.png";
import logoSena from "./media/assets/logoVerdeSENA.png";
...
import Register from "../components/ModalRegister/Registro";
              ...
              <div className="flex flex-col mt-3">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    console.log(abrirRegister); // Verificar que el estado cambie correctamente
                  }}
                  className="text-blue-500"
                >
                  Regístrate.
                </button>
                <Link className="text-blue-500 text-center mt-2">¿Olvidaste tu contraseña?</Link>
              </div>
            </form>
          </div>
        </div>
